...
export default function Header() {
  ...
  return ( <header className='p-5 flex flex-cols bg-[#585757]'>
    ...
    <h1 className='flex flex-row text-bold font-bold font-weight z-10 absolute top-10 left-10 text-[#383838] -mt-4 dark:text-[#d6d6d6]'>
      Command Center
      </h1> 
      ...
      <section className='font-semibold md:pl-[30rem] sm:pl-8'>
        <image className='p-8 absolute top-6 right-[6rem]'>profile image </image>
            <div>
              <a href="/swap" className='p-8'>swap chains</a>
